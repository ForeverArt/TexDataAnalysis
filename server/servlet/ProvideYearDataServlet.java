 ...
 */
@WebServlet("/ProvideYearDataServlet")
public class ProvideYearDataServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	ArrayList<Receipt> receipts = receiptDao.searchByYear(year);
